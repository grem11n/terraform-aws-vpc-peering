...
func TestSingleAccountSingleRegionOptions(t *testing.T) {
	// TF files folders
	fixturesDir := "./fixtures/single-account-single-region-with-options"
	moduleDir := "../examples/single-account-single-region-with-options"
	// Assertions
